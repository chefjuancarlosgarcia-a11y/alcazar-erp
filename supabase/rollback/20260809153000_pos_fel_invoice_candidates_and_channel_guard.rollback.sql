-- Rollback 20260809153000_pos_fel_invoice_candidates_and_channel_guard.sql
-- Restores request_pos_fel_certification body from 20260808230000 (no sales_channel guard).

drop function if exists public.list_pos_fel_invoice_candidates(integer, integer, uuid);

drop function if exists public.fel_assert_pos_fel_pilot_sales_channel(text);
